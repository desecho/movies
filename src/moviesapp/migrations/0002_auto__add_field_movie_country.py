...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'movies_movie', 'country',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'movies_movie', 'country')
    ...
    models = {
        ...
        u'movies.record': {
            ...
            'movie': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'records'", 'to': u"orm['movies.Movie']"}),
