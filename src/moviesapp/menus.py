...
feed_children = (MenuItem(_('Friends'), reverse('feed', kwargs={'list_name': 'friends'}),
                          check=has_friends), MenuItem(_('People'), reverse('feed', kwargs={'list_name': 'people'})))
...
Menu.add_item('main', MenuItem(_('To Watch'),
                               reverse('list', kwargs={'list_name': 'to-watch'}),
